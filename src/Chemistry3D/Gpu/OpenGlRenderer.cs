...
using Models_AppContext = Chemistry3D.Models.AppContext;
...
namespace Chemistry3D.Gpu
{
    public class OpenGlRenderer
    {
        ...
        public void ResetOrigin()
        {
            ...
            center = new Vector4(-app.simulation.config.fieldSize / 4, app.simulation.config.fieldSize / 4, - app.simulation.config.fieldSize / 4, 1.0f);
